...
class DeploymentConfigurationProfileTest {

    @Test
    void testDeploymentConfigurationProfile_FormatError() {
        var dcp = new DeploymentConfigurationProfile();
    ...
    @Test
    void testDeploymentConfigurationProfile_Getters() {
        var dcp = new DeploymentConfigurationProfile();
    ...
    @Test
    void testDeploymentConfigurationProfile_WithInlineProfile_ViaPluginDeploymentName() {
        var dcp = new DeploymentConfigurationProfile();
    ...
    @Test
    void testDeploymentConfigurationProfile_WithInlineProfile() {
        var dcp = new DeploymentConfigurationProfile();
    ...
    @Test
    void testDeploymentConfigurationProfile_WithMappedProfile() {
        var dcp = new DeploymentConfigurationProfile();
    ...
    @Test
    void testDeploymentConfigurationProfile_WithDefaultProfile() {
        var dcp = new DeploymentConfigurationProfile();
    ...
    @Test
    void testDeploymentConfigurationProfile_WithNoSettings() {
        var dcp = new DeploymentConfigurationProfile();
